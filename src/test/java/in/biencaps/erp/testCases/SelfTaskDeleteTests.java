 ...
 */
public class SelfTaskDeleteTests extends BaseTest {
	...
	public static Logger log = LogManager.getLogger(SelfTaskDeleteTests.class);
...
//		Thread.sleep(2000);
	...
	public void verify_Log_Message_After_Task_Delete_From_Day_View() throws InterruptedException {
		myActivitiesFun.verify_Log_Message(LoginAndForgotPasswordTests.actualEmployeeName, "has deleted",
	...
	public void verify_Total_Tasks_Count_In_Day_View_After_Deleting_Single_Task() throws InterruptedException {
		...
		if (totalCheckboxesInDayView == 1) {
			...
			AddSelfTaskAndCheckInDayViewTests.totalTasksCount = 0;

			commonMethods.verify_Total_Tasks_Count_In_Day_View_After_Added_Or_Deleted_Task(
					AddSelfTaskAndCheckInDayViewTests.totalTasksCount);
		} else {
			...
			AddSelfTaskAndCheckInDayViewTests.totalTasksCount = AddSelfTaskAndCheckInDayViewTests.totalTasksCount
					- 1;
...
//		Thread.sleep(2000);
	...
	public void verify_Total_Tasks_Count_In_Day_View_After_Deleting_All_Tasks() throws InterruptedException {
		...
		AddSelfTaskAndCheckInDayViewTests.totalTasksCount = 1;
