...
public class MyTasksPage {
	...
	public By tagDropdownInSidebar = By
			.xpath("//div[contains(@class,'Tags')]//div[contains(@class,'newAddTaskAssignee')]");
	...
	public By addTasksButtonInSidebar = By.xpath("//button[@id='AddTaskBtn']");
	...
	public By multipleCheckBoxInDayView = By.xpath("//input[@id='allSelectChecBox']");
	...
	public By searchBarInDayView = By.xpath("//input[@placeholder='Search']");
	...
	public By taskGitlinkInputTextfieldInDayView = By.xpath("//input[@id='gitInputBox']");
	...
	public By saveButtonForUpdateTaskOfSidebarInDayView = By.xpath("//button[@id='btnSave']");
...
//					.xpath("//span[@aria-disabled='false'][normalize-space()='" + randomDate + "']");
	...
	public void clickOnRandomValueFromDropdownWhileAddTaskFromSidebar() {
		List<WebElement> values = driver.findElements(valuesFromDropdownInSidebar);
		int randomIndex = random.nextInt(values.size());
		WebElement randomValue = values.get(randomIndex);
		webElementActions.clickOnMethod(randomValue);
	}
	...
	public String checkLastTaskCommentTextInDayView() {
		return webElementActions.getAtrributeMethod(lastTaskCommentTextfieldInDayView);
	}
	...
	public String checkSearchedTaskInDayView(String searchKey) throws InterruptedException {
		...
		return webElementActions.getAtrributeMethod(searchBarInDayView);
	}
	...
	public String checkNewUpdatedGitlinkInDayView() {
		return webElementActions.getAtrributeMethod(taskGitlinkInputTextfieldInDayView);
	}
